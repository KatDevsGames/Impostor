...
{
    /// <summary>
    /// An implementation of <see cref="Effect"/> which sabotages the electric system
    /// </summary>
    public class SabotageElectricEffect : Effect
    {
        public override string Code => "SabotageElectric";
        ...
        internal SabotageElectricEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory)
            : this(game, gameManager, gameStateTracker, externalCommandFactory, Serilog.Log.ForContext<SabotageElectricEffect>())
        {

        }

        /// <summary>
        /// Internal ctor for creating a <see cref="SabotageElectricEffect"/>
        /// </summary>
        ...
        internal SabotageElectricEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory, ILogger logger)
        {
        ...
        /// We can't run this game if the Electric system is already sabotaged
        /// </summary>
        ...
        public override bool Start(Request context)
        {
            ...
            else
            {
                ...
                {
                    logger.Write(Serilog.Events.LogEventLevel.Debug, $"{this.GetType().Name} Start returned False, Electrical is already sabotaged!");
                    return false;
                }
            }
