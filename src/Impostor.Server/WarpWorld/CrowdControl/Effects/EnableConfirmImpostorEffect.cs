...
{
    /// <summary>
    /// An implementation of <see cref="Effect"/> which enables confirming impostor
    /// </summary>
    public class EnableConfirmImpostorEffect : Effect
    {
        public override string Code => "EnableConfirmImpostor";
        ...
        internal EnableConfirmImpostorEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory)
            : this(game, gameManager, gameStateTracker, externalCommandFactory, Serilog.Log.ForContext<EnableConfirmImpostorEffect>())
        {

        }

        /// <summary>
        /// Internal ctor for creating a <see cref="EnableConfirmImpostorEffect"/>
        /// </summary>
        ...
        internal EnableConfirmImpostorEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory, ILogger logger)
        {
        ...
        /// We also cannot run this effect if Confirm Impostor is already enabled
        /// </summary>
        ...
        public override bool Start(Request context)
        {
            ...
            {
                // If confirm impostor is already enabled, we can't enable it again. 
                // This should get caught by IsReady but can't hurt to check twice
                logger.Write(Serilog.Events.LogEventLevel.Debug, $"{this.GetType().Name} Start returned False, ConfirmImpostor is already enabled!");
                return false;
            }
            ...
            // Update the options to enable confirm impostor
            ...
            updatePayload.GameOptions.ConfirmImpostor = true;
