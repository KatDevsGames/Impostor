...
{
    /// <summary>
    /// An implementation of <see cref="Effect"/> which increments the voting time by <see cref="VotingTimeIncrement"/>
    /// </summary>
    public class IncrementVotingTimeEffect : Effect
    {
        public override string Code => "IncrementVotingTime";
        ...
        internal const int VotingTimeIncrement = 10; // TODO - Config

        internal IncrementVotingTimeEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory)
            : this(game, gameManager, gameStateTracker, externalCommandFactory, Serilog.Log.ForContext<IncrementVotingTimeEffect>())
        {

        }

        /// <summary>
        /// Internal ctor for creating a <see cref="IncrementVotingTimeEffect"/>
        /// </summary>
        ...
        internal IncrementVotingTimeEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory, ILogger logger)
        {
        ...
        public override bool Start(Request context)
        {
            ...
            // Update the options to include the incremented voting time
            ...
            updatePayload.GameOptions.VotingTime += VotingTimeIncrement;
