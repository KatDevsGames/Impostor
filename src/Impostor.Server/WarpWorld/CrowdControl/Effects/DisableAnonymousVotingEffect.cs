...
{
    /// <summary>
    /// An implementation of <see cref="Effect"/> to disable Anonymous Voting
    /// </summary>
    public class DisableAnonymousVotingEffect : Effect
    {
        public override string Code => "DisableAnonymousVoting";
        ...
        internal DisableAnonymousVotingEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory)
            : this(game, gameManager, gameStateTracker, externalCommandFactory, Serilog.Log.ForContext<DisableAnonymousVotingEffect>())
        {

        }

        /// <summary>
        /// Internal ctor for creating a <see cref="DisableAnonymousVotingEffect"/>
        /// </summary>
        ...
        internal DisableAnonymousVotingEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory, ILogger logger)
        {
        ...
        /// We also cannot run this effect if Anonymous Voting is already disabled
        /// </summary>
        ...
        public override bool Start(Request context)
        {
            ...
            {
                // If anonymous voting is already disabled, we can't disable it again. 
                // This should get caught by IsReady but can't hurt to check twice
                logger.Write(Serilog.Events.LogEventLevel.Debug, $"{this.GetType().Name} Start returned False, AnonymousVotes are already disabled");
                return false;
            }
            ...
            // Update the options to disable Anonymous Voting
            ...
            updatePayload.GameOptions.AnonymousVotes = false;
