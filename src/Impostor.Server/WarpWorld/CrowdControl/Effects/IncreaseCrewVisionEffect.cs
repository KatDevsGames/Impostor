...
{
    /// <summary>
    /// An implementation of <see cref="Effect"/> which temporarily increases the crew's vision
    /// </summary>
    public class IncreaseCrewVisionEffect : Effect
    {
        public override string Code => "IncreaseCrewVision";
        ...
        internal const float IncrementedCrewVisionScale = 2.0f; // TODO - Config

        internal IncreaseCrewVisionEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory)
            : this(game, gameManager, gameStateTracker, externalCommandFactory, Serilog.Log.ForContext<IncreaseCrewVisionEffect>())
        {

        }

        /// <summary>
        /// Internal ctor for creating a <see cref="IncreaseCrewVisionEffect"/>
        /// </summary>
        ...
        internal IncreaseCrewVisionEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory, ILogger logger)
        {
        ...
        public override bool Start(Request context)
        {
            ...
            // Update the options to include increased crew vision
            ...
            updatePayload.GameOptions.CrewLightMod = startingGameData.CrewLightMod * IncrementedCrewVisionScale;
