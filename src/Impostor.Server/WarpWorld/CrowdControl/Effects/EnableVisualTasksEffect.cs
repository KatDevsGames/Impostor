...
{
    /// <summary>
    /// An implementation of <see cref="Effect"/> for enabling visual tasks
    /// </summary>
    public class EnableVisualTasksEffect : Effect
    {
        public override string Code => "EnableVisualTasks";
        ...
        internal EnableVisualTasksEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory)
            : this(game, gameManager, gameStateTracker, externalCommandFactory, Serilog.Log.ForContext<EnableVisualTasksEffect>())
        {

        }

        /// <summary>
        /// Internal ctor for creating a <see cref="EnableVisualTasksEffect"/>
        /// </summary>
        ...
        internal EnableVisualTasksEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory, ILogger logger)
        {
        ...
        /// We also cannot run this effect if Visual Tasks are already enabled
        /// </summary>
        ...
        public override bool Start(Request context)
        {
            ...
            {
                // If visual tasks are already enabled, we can't enable it again. 
                // This should get caught by IsReady but can't hurt to check twice
                logger.Write(Serilog.Events.LogEventLevel.Debug, $"{this.GetType().Name} Start returned False, VisualTasks are already enabled!");
                return false;
            }
            ...
            // Update the options to enable visual tasks
            ...
            updatePayload.GameOptions.VisualTasks = true;
