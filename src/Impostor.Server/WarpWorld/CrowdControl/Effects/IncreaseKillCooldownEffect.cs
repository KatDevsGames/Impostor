...
{
    /// <summary>
    /// An implementation of <see cref="Effect"/> which temporarily increases the Impostor kill cooldown
    /// </summary>
    public class IncreaseKillCooldownEffect : Effect
    {
        public override string Code => "IncreaseKillCooldown";
        ...
        internal const float IncrementedKillCooldownScale = 1.5f; // TODO - Config

        internal IncreaseKillCooldownEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory)
            : this(game, gameManager, gameStateTracker, externalCommandFactory, Serilog.Log.ForContext<IncreaseKillCooldownEffect>())
        {

        }

        /// <summary>
        /// Internal ctor for creating a <see cref="IncreaseKillCooldownEffect"/>
        /// </summary>
        ...
        internal IncreaseKillCooldownEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory, ILogger logger)
        {
        ...
        public override bool Start(Request context)
        {
            ...
            // Update the options to include increased kill cooldown
            ...
            updatePayload.GameOptions.KillCooldown = startingGameData.KillCooldown * IncrementedKillCooldownScale;
