...
{
    /// <summary>
    /// An implementation of <see cref="Effect"/> which fixes the O2 
    /// </summary>
    public class FixO2Effect : Effect
    {
        public override string Code => "FixO2";
        ...
        public const uint EffectID = 27;

        internal FixO2Effect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory)
            : this (game, gameManager, gameStateTracker, externalCommandFactory, Serilog.Log.ForContext<FixO2Effect>())
        {

        }

        /// <summary>
        /// Internal ctor for creating a <see cref="FixO2Effect"/>
        /// </summary>
        ...
        internal FixO2Effect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory, ILogger logger)
        {
        ...
        /// We can't run this game if the O2 system is already fixed
        /// </summary>
        ...
        public override bool Start(Request context)
        {
            ...
            {
                logger.Write(Serilog.Events.LogEventLevel.Debug, $"{this.GetType().Name} Start returned False, O2 is already fixed!");
                return false;
            }
