...
{
    /// <summary>
    /// An implementation of <see cref="Effect"/> which temporarily increases the impostor's vision
    /// </summary>
    public class IncreaseImpostorVisionEffect : Effect
    {
        public override string Code => "IncreaseImpostorVision";
        ...
        internal const float IncrementedImpostorVisionScale = 2f; // TODO - Config

        internal IncreaseImpostorVisionEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory)
            : this(game, gameManager, gameStateTracker, externalCommandFactory, Serilog.Log.ForContext<IncreaseImpostorVisionEffect>())
        {

        }

        /// <summary>
        /// Internal ctor for creating a <see cref="IncreaseImpostorVisionEffect"/>
        /// </summary>
        ...
        internal IncreaseImpostorVisionEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory, ILogger logger)
        {
        ...
        public override bool Start(Request context)
        {
            ...
            // Update the options to include increased impostor vision
            ...
            updatePayload.GameOptions.ImpostorLightMod = startingGameData.ImpostorLightMod * IncrementedImpostorVisionScale;
