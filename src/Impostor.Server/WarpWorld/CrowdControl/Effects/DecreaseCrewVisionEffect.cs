...
{
    /// <summary>
    /// An implementation of <see cref="Effect"/> which temporarily decreases the crew's vision
    /// </summary>
    public class DecreaseCrewVisionEffect : Effect
    {
        public override string Code => "DecreaseCrewVision";
        ...
        public override string[] Mutex => new string[] { "CrewVision" };
        ...
        internal const float DecrementedCrewVisionScale = 0.5f; // TODO - Config

        /// <summary>
        /// Internal ctor for creating a <see cref="DecreaseCrewVisionEffect"/>
        /// </summary>
        ...
        internal DecreaseCrewVisionEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory) 
            : this(game, gameManager, gameStateTracker, externalCommandFactory, Serilog.Log.ForContext<DecreaseCrewVisionEffect>())
        {
        }
        ...
        internal DecreaseCrewVisionEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory, ILogger logger)
        {
        ...
        public override bool Start(Request context)
        {
            ...
            // Update the options to include decreased crew vision
            ...
            updatePayload.GameOptions.CrewLightMod = startingGameData.CrewLightMod * DecrementedCrewVisionScale;
        ...
        public override bool Stop()
        {
            ...
            // Update the options to be whatever they are currently, but with the player vision set back to what it was when the game started
            var updateCommand = externalCommandFactory.GetExternalCommand<UpdateGameExternalCommand>();
            var updatePayload = new UpdateGamePayload()
            {
                Code = game.Code,
            ...
            updatePayload.GameOptions.CrewLightMod = startingGameData.CrewLightMod;
            IExternalCommandResponse<Game> updateResponse = updateCommand.PerformCommand(updatePayload).Result;
