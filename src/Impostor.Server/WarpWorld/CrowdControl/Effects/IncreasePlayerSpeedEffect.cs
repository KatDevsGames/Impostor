...
{
    /// <summary>
    /// An implementation of <see cref="Effect"/> which temporarily increases the players speed
    /// </summary>
    public class IncreasePlayerSpeedEffect : Effect
    {
        public override string Code => "IncreasePlayerSpeed";
        ...
        internal const float IncrementedPlayerSpeedScale = 2.0f; // TODO - Config

        internal IncreasePlayerSpeedEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory)
            : this(game, gameManager, gameStateTracker, externalCommandFactory, Serilog.Log.ForContext<IncreasePlayerSpeedEffect>())
        {

        }

        /// <summary>
        /// Internal ctor for creating a <see cref="IncreasePlayerSpeedEffect"/>
        /// </summary>
        ...
        internal IncreasePlayerSpeedEffect(IGame game, GameManager gameManager, IGameStateTracker gameStateTracker, IExternalCommandFactory externalCommandFactory, ILogger logger)
        {
        ...
        public override bool Start(Request context)
        {
            ...
            // Update the options to include increased player speed
            ...
            updatePayload.GameOptions.PlayerSpeedMod = startingGameData.PlayerSpeedMod * IncrementedPlayerSpeedScale;
